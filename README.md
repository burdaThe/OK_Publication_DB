...
###### 
Университетское групповое задание **по сбору данных о публикациях** **в** социальной сети **OK**. 

###### 
Выполнено **BarbieKenn(Python)**, **MonforSalentaiel(Python)**, **burdaThe(C#)**.
...
##### &nbsp;	1. **Запуск парсера через main.py и получение json-файла**

#####  	2. **Запуск импортера из json-файла в db-файл через json\_to\_sql/json\_to\_sql.sln**
